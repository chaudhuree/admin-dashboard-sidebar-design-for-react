...
export default function NavSidebar() {
  ...
  // references
  let  sidePanelref,searchBoxRef,searchMobileTriggerIconRef =useRef();
  ...
  return (
    <header className="app-header fixed-top">
        ...
        <div className="container-fluid py-2">
          <div className="app-header-content">
            <div className="row justify-content-between align-items-center">
              ...
              <div className="search-mobile-trigger d-sm-none col" onClick={SearchMobileTriggerHandler}>
                {isSearchBoxVisible ? <BsSearch className="search-mobile-trigger-icon"/>:<BsXLg className="search-mobile-trigger-icon"/> }
                
              </div>
              <div ref={(div)=>(searchBoxRef=div)} className="app-search-box col">
      ...
      <div ref={(div)=> (sidePanelref=div)} id="app-sidepanel" 
       className={isSidePanelVisible ? "sidepanel-visible app-sidepanel" : "sidepanel-hidden app-sidepanel"}>
        <div id="sidepanel-drop" className="sidepanel-drop"  onClick={SidebarClickHandler}/>
